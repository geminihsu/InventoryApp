...
public class LocationHelper {
    ...
    public static int MapZoneCode(String location)
    {
        ...
        else if (locNum >= Constrant.ZONE_CODE_2_MIN && locNum <= Constrant.ZONE_CODE_2_MAX && locNum != Constrant.ZONE_CODE_3_A && locNum != Constrant.ZONE_CODE_3_B && locNum != Constrant.ZONE_CODE_3_C && locNum != Constrant.ZONE_CODE_3_D && locNum != Constrant.ZONE_CODE_4)
        {
            if (locNum % 10 == 1 || locNum % 10 == 2)
                code = Constrant.ZONE_CODE_2;
        }
        else if (locNum == Constrant.ZONE_CODE_3_A || locNum == Constrant.ZONE_CODE_3_B || locNum == Constrant.ZONE_CODE_3_C || locNum == Constrant.ZONE_CODE_3_D)
        {
